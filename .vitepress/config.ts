		...
		sidebar: [
			{
				...
				items: [
					...
					{ text: 'ISOTYPE', link: '/tag/isotype' },
					{ text: 'Lists of Influences', link: '/tag/influences' },
					{ text: 'EagerEyes Videos', link: '/tag/eagereyestv' },
					{ text: 'Peer Review', link: '/tag/peer-review' },
					{ text: 'Conference Reports', link: '/tag/conference' },
					{ text: 'Visualization Basics', link: '/tag/basics' },
					{ text: 'Journalism', link: '/tag/journalism' },
					{ text: 'Meta/Site News', link: '/tag/meta' },
					{ text: 'Papers', link: '/tag/paper.md' },
					{ text: 'ZIPScribble Maps', link: '/tag/zipscribble' },
				]
			},
			{
				text: 'Blog',
				collapsed: true,
				items: [
					{ text: '2025', link: '/blog/2025' },
					{ text: '2024', link: '/blog/2024' },
					{ text: '2023', link: '/blog/2023' },
					{ text: '2022', link: '/blog/2022' },
					{ text: '2021', link: '/blog/2021' },
					{ text: '2020', link: '/blog/2020' },
					{ text: '2019', link: '/blog/2019' },
					{ text: '2018', link: '/blog/2018' },
					{ text: '2017', link: '/blog/2017' },
					{ text: '2016', link: '/blog/2016' },
					{ text: '2015', link: '/blog/2015' },
					{ text: '2014', link: '/blog/2014' },
					{ text: '2013', link: '/blog/2013' },
					{ text: '2012', link: '/blog/2012' },
					{ text: '2011', link: '/blog/2011' },
					{ text: '2010', link: '/blog/2010' },
					{ text: '2009', link: '/blog/2009' },
					{ text: '2008', link: '/blog/2008' },
					{ text: '2007', link: '/blog/2007' },
					{ text: '2006', link: '/blog/2006' }
				]
			},
		],
