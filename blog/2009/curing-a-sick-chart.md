...
>	<p>Robert,</p>
>	<p>I think there is benefit to both the stacked relative costs that add up to 100% as I used&nbsp;<a href="http://www.theusRus.de/Blog-files/TotalCostShare.png">here</a>&nbsp;as well as the "split up" version you use&nbsp;<a href="/media/2009/sickchart/patients-age-disease-thumb.png">above</a>. A single mouse click should take you from one view to the other. The split up version definitely face the problem that you can not use the plot space very efficiently - a problem which all small multiples have.</p>
