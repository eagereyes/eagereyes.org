...
<a href="http://eagereyes.org/blog/2010/visualization-without-pictures"><img src="http://eagereyes.org/media/2010/empty-frame.jpg" alt="" width="560" height="374" /></a>

A question that I have been asked a few times recently is: what about visualization for the blind? Would it make sense to provide a textual representation? What about a representation that you can feel and touch, isn't that a visualization? And is there perhaps more to visualization than just the pictures?<!--more-->
<h2 id="visual_and_non_visual_visualization">Visual and Non-Visual Visualization?</h2>
...
<h2 id="beyond_the_pictures">Beyond the Pictures</h2>
