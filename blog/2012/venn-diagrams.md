...
In the medical and bioinformatics literature, Venn diagrams are a popular way of showing different study conditions, sometimes with the intention of directly reflecting set sizes, sometimes with annotations. Rather than insist on Venn diagrams, it would be a better idea to use better alternatives, like <a href="http://eagereyes.org/criticism/autism-diagnosis-accuracy">I have shown</a> <a href="http://eagereyes.org/blog/2008/sightings-a-vennerable-challenge">in the past</a>.
