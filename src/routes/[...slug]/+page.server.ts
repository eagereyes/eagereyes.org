...
const REDIRECTS: Record<string, string> = {
    ...
    'zipscribble-maps/australia': '/app/zipscribble-map#au',
    'zipscribble-maps/austria': '/app/zipscribble-map#at',
    'zipscribble-maps/canada': '/app/zipscribble-map#ca',
    ...
    'zipscribble-maps/spain': '/app/zipscribble-map#es',
    'zipscribble-maps/sweden': '/app/zipscribble-map#se',
    'zipscribble-maps/switzerland': '/app/zipscribble-map#ch',
    'zipscribble-maps/united-states': '/app/zipscribble-map#us',
