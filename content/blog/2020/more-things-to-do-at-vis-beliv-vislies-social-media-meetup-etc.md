...
[The IEEE VIS Twitter account](https://twitter.com/ieeevis) has also been busy tweeting short summaries of all the papers with links to materials. If you missed it, it's worthwhile to scroll back through and check out the ones you're interested in.

## Sunday: BELIV

[BELIV](https://beliv-workshop.github.io/schedule.html) is always an interesting event if you're looking to learn more about the thinking around visualization and evaluation. The keynote by John Burn-Murdoch, who has been doing amazing work covering COVID-19 at the *Financial Times*, should be particularly interesting. BELIV takes place all day Sunday, which of course collides with [VisComm](https://viscomm.io). But you can watch the keynote and morning sessions and then head over to VisComm!

## Tuesday: VisLies

[VisLies](http://www.vislies.org/2020/) has been around for many years, and has been a lot of fun. The idea is to find bad examples of visualizations, but then to understand what went wrong. It's both a fun event and very educational. It takes place 1:40pm-3pm MDT on Tuesday, October 27.
...
[The meetup page on the virtual VIS website](https://virtual.ieeevis.org/session_m-publish.html) currently doesn't have much information, though it does have the zoom link.
