<figure><img src="https://media.eagereyes.org/media/2008/LinearQuadratic-teaser.png" alt="Linear vs. Quadratic"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/2008/FastFood.jpg" alt="Fast Food Chains"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/2008/LinearQuadratic-Line.png" alt="Linear Change"/></figure>

becomes a quadratic change:

<figure><img src="https://media.eagereyes.org/media/2008/LinearQuadratic-Square.png" alt="Quadratic Change"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/2008/LinearQuadratic-QuarterCircle.png" alt="Quadratic Change in Circle"/></figure>
...
[Florence Nightingale](http://www.florence-nightingale.co.uk/) already knew this in 1858 when she developed her [coxcomb chart](http://www.uh.edu/engines/epi1712.htm) (a predecessor to the pie chart): she represented the numbers of soldiers using the area, not the radius, of the circle segments.

<figure><img src="https://media.eagereyes.org/media/2008/coxcombchart.jpg" alt="Nightingale"/></figure>

A similar effect can be seen in the [petal chart](http://chandoo.org/wp/2008/09/18/better-radar-charts-excel/) or [star glyph](http://davis.wpi.edu/~xmdv/vis_starglyph.html), which connects points on a number of axes that radiate from a common point. Whether they are filled in or not, the impression is that of an enclosed area, and that changes in a quadratic way similar to the circle segments above.

<figure><img src="https://media.eagereyes.org/media/2008/starglyph-cropped.png" alt="star glyphs"/></figure>
