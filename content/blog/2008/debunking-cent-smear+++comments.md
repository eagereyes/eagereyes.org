[Christopher Collins](http://www.christophercollins.ca) says…
...
>
> [
> http://www.fec.gov/DisclosureSearch/MapAppDownload.do?cand_id=P00000001&cand_nm_title=All%20Candidates&downloadComeFrom=mapApp](http://www.fec.gov/DisclosureSearch/MapAppDownload.do?cand_id=P00000001&cand_nm_title=All%20Candidates&downloadComeFrom=mapApp)
>
> I hope this helps.
> Robert Morton
> Tableau Software
...
Robert Kosara says…
> I know about the NYTimes API, but they only do aggregates (and not the one I needed here). Otherwise, that would have been a good idea, no question.

Robert Kosara says…
> That's a very useful link, thank you! Interestingly, there are very few McCain contributions with "odd" cents.

Robert Kosara says…
> I almost wrote something about leaving the eye candy in because it didn't hurt. But I guess you're right, I'll remove that.
