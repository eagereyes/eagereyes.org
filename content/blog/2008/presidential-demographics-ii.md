...
You will perhaps notice the one timeline that is broken into two. [Grover Cleveland](http://en.wikipedia.org/wiki/Grover_Cleveland) served two non-consecutive terms, which I decided to show so that he does not look like two separate people.

---

The [source code of this applet is available](https://github.com/eagereyes/PresidentialDemographics).
