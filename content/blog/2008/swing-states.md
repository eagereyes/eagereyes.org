...
The data for this chart was collected from the [U.S. National Archives and Records Administration](http://www.archives.gov/federal-register/electoral-college/votes/index.html), which unfortunately does not provide this in a very usable format. The format also switches at some point, making things more work than necessary. I had originally collected the data in a year-by-state matrix, which turned out to be a poor choice. I used [Hadley Wickham's reshape package for R](http://had.co.nz/reshape/) to "melt" the data into a more useful format. That data was then fed to [Tableau](http://www.tableausoftware.com/) to produce this chart.
...
Data: [Elections_1904-2004.zip](https://media.eagereyes.org/media/2008/Elections_1904-2004.zip)
