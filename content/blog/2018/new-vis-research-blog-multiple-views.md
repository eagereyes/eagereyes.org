...
The goal of *Multiple Views* is to provide this access: paper explainers, reports from conferences, background on a variety of visualization topics, etc. Jessica Hullman has written [a nice introduction of what we think the visualization research is and should be](https://medium.com/multiple-views-visualization-research-explained/what-is-visualization-research-what-should-it-be-8840a9ba658), and the current list of postings includes thoughts on visualization literacy, some background on perceptual studies in visualization, a couple VIS reports, etc.
...
Subscribe either [on Medium](https://medium.com/multiple-views-visualization-research-explained) or through the RSS feed!
