...
What could be more interesting than cars? I mean, come on – they’re cars! And I’m not talking about boring Priuses or self-driving cars or any of that newfangled stuff. No, these are from the time when cars were still *cars*: the 1970s and early 80s. That’s what the [cars dataset](http://www.rpubs.com/dksmith01/cars) is all about (there are, it turns out, lots of car-related datasets, but there’s only one true *cars*). Real cars. Manly cars.
...
If the cars dataset seems a bit dated, surely the [iris data](https://archive.ics.uci.edu/ml/datasets/iris) will answer your burning questions. Who hasn’t stared at an iris plant and gone crazy trying to decide whether it’s an *iris setosa*, *versicolor*, or maybe even *virginica*? It’s the stuff that keeps you up at night for days at a time.
...
Actually, it turns out that this data is even older than the cars! [It's from a 1936 paper](https://en.wikipedia.org/wiki/Iris_flower_data_set)! They sure knew their irises in the 30s. And it's not like plants change all that much in 80 years.

## Titanic

Of all the datasets, the [*Titanic* data](http://stat.ethz.ch/R-manual/R-devel/library/datasets/html/Titanic.html) is clearly the most dramatic. Who isn't obsessed with the disaster that happened over 100 years ago? Who hasn’t seen the movie that came out in 1997, which is, uh, just over 20 years ago now? I mean, who over the age of 40, of course (millennials don’t know anything, as usual)?
