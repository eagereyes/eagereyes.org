...
These glimpses are meant to be extended tweets, which I find too limiting to describe what I'm thinking during talks. That also gives you a chance to comment, criticize my opinions, point to more information, etc. In addition, I will also use Twitter this time around, so [follow me](http://twitter.com/EagerEyes) if you want to get all the information. While I don't want to promise too much, I will also try to get some pictures up a bit closer to real-time than usual (i.e., not three months later). No guarantees on that, though.

## Others

[Charl Botha](http://cpbotha.net/) will not only be liveblogging from this year's VisWeek next week, but also [from next year's](http://cpbotha.net/2009/10/05/weekly-head-voices-6-heroic-wave-brainy-mice-dont-shoot-the-messenger/) at the same time &ndash; so don't get confused! Charl is also [on Twitter](http://twitter.com/cpbotha).

[Carlos Scheidegger](http://carlosscheidegger.wordpress.com/) has blogged about VisWeek in the past, and I'm sure he will again this year. Like many other young people these days, he can also be found [spreading his wisdom on Twitter](http://twitter.com/scheidegger).

VisWeek also now has a [Twitter account](http://twitter.com/visweek), which will be fed by Carlos (and others?). There isn't anything there yet, but expect lots of activity next week (and make sure to complain to Carlos if there isn't; or if there is too much SciVis and no InfoVis).
