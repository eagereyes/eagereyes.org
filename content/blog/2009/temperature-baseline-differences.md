...
After the discussion about baseline data in [previous postings](/data/a-look-at-climate-data), I decided to crunch some more numbers. The view below is a first start, though more can obviously be done. The map lets you pick one of the stations that have produced gapless data from 1969 to 1978 and 1999 to 2008, and for which a baseline is available ([CSV file available here](https://media.eagereyes.org/media/2009/climate/climatedata-subset.csv.zip)). These baselines were determined over the period from 1961 to 1990, so I chose a period of ten years that lies well within that range. The view below lets you compare those to the last ten years, to see how things have changed.
