...
The [Symposium on Large-Scale Data Analysis and Visualization (LDAV)](http://ldav.org) was a mixed bag. While I enjoyed [Pat Hanrahan’s keynote](/blog/2012/visweek-2012-day-one), I was shocked when I saw the best paper. There were some redeeming papers, but the quality overall was quite low.
...
[*How Capacity Limits of Attention Influence Information Visualization Effectiveness*](http://steveharoz.com/research/attention/papers/Haroz_Whitney_2012_InfoVis.pdf) by Steve Haroz and David Whitney was the deserved winner of the Best Paper award. Not only is the paper highly interesting and relevant, Haroz also gave one of the best talks all week. Instead of dwelling on small details, he presented his findings clearly and talked about concrete lessons learned from his work. Talk about basic research being useful.
...
Soon after the presentation, a Twitter user called *viscritic* (whose account seems to have been deleted in the meantime) started attacking the paper on an anonymous webpage. Haroz responded by posting [a brief but clear comment with some demo videos](http://steveharoz.com/blog/?p=203).
...
Lane Harrison, Roman Pyzh, and Drew Skau have written up [some great notes](https://docs.google.com/document/d/1wYjaJqlN1m12_ST-TC8lPAMEY4AmB_JA-30HRnm8GgQ/edit) for many of the sessions, with additional comments and links.
