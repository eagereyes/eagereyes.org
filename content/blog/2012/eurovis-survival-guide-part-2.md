...
The local currency is called the Euro (pronounced *oy-raw*). Don't be confused by the different colors of the banknotes, it is real money. In case you're from [a place where all the money looks the same](http://en.wikipedia.org/wiki/United_States), you will feel like you're color blind for a few days after your return. It's also important to realize that coins have actual value: the smallest banknote is €5 (around $6.25), anything below that are coins. So don't just leave those somewhere, they add up fast.
...
Once you're sure about the voltage, you will need a plug adapter. [Austrian plugs have two round pins](http://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#Europlug_compatible_standards), like most of the rest of Europe (with the exception of [the crazy British contraption](http://en.wikipedia.org/wiki/AC_power_plugs_and_sockets#British_and_compatible_standards)). Some outlets will also accept American-style flat plugs, but those are not very common. Adapters are easy to get though, and your hotel reception should be able to help you.
...
Nobody in Austria has seen *[The Sound of Music](http://www.imdb.com/title/tt0059742/)*. Nobody. People will not get your references and they won't be able to sing your favorite songs with you. Save yourself the frustration and don't even bring it up.

Austrians are proud of their beer (Bier, *beer*) and wine (Wein, *vine*). You will get a sense of the latter at the social event, which will be held at a *Heurigen*. I don't think there's a way to translate that, but think: lots of wine and fatty food, fun, song, and a guy [playing zither in the background](http://www.youtube.com/watch?v=n4JpDUMXBqo).

The Viennese in particular, but Austrians in general, [have a thing for the morbid](http://en.wikipedia.org/wiki/Oh_du_lieber_Augustin). You don't understand Austria until you've experienced the dark, bottomless depths of self-denial, existential dread, and morbid fatalism that lie at the center of the Austrian soul. While you will never quite get it as an outsider, you can at least get a taste of it by visiting the [Funeral Museum](http://www.wien.info/en/sightseeing/sights/from-a-to-f/funeral-museum), the [Museum of Pathological Anatomy](http://www.narrenturm.at/), or one of the [many cemeteries](http://www.wien.info/en/sightseeing/sights/cemeteries). The [Central Cemetery](http://www.wien.info/en/sightseeing/sights/from-s-to-z/central-cemetery) is particularly interesting because of its old Jewish part with gravestones that haven't been touched in 100 years or more (it's also the subject of a [popular 1970s pop song](http://www.youtube.com/watch?v=zrmlJm9JNJA)). The best time to go there is early in the morning on a foggy day (not very likely in early June, though).
...
As you walk over there from the conference venue, you will pass the world's largest floating trampoline. It's not a hallucination caused by too much alcohol and too many talks, it's real. Here's [a video of a kid enjoying himself there](http://www.youtube.com/watch?v=5ZFJzHP0_iM). I can't find a website for the thing, but it's worth checking out. It's a bizarre sight when the sun sets and there are bodies tumbling through the air, carefree and unaware of what's going on around them.

Another fun part of Vienna is the [Prater](http://en.wikipedia.org/wiki/Prater). It consists of a large park, with a permanent fairground in one part. Yes, that's where you will find the [Riesenrad](http://en.wikipedia.org/wiki/Wiener_Riesenrad). The fairground (also called *Wurstelprater*) has a certain morbid flair to it, in particular when you walk through it on a rainy day and you run into the Hieronymus Bosch-style statues of clowns that are all attached to each other with heads and hands sticking out everywhere.
