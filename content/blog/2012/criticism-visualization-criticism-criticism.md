...
Criticism in visualization can be harsh, pedantic, and stupid. But it is also a useful tool that shows the thinking behind the seemingly simple graphical shapes we use, and teaches people things they might not be aware of. While I largely agree with [Andy Kirk's criticism of visualization criticism](http://radar.oreilly.com/2012/07/visualization-criticism.html) and the danger of scaring people away from visualization, his "grown-up criticism" argument cuts both ways: grown-ups can argue a point without getting upset.

It's not like all the web would be hostile to visualization experiments; far from it. Look at websites like [infosthetics](http://infosthetics.com/) and [flowingdata](http://flowingdata.com/), which present links to lots of visualizations, good and bad, with little to no criticism. Now compare their traffic to what I am getting here, or what [Bryan Connor's *The Why Axis*](http://thewhyaxis.info/) is getting, or [Kaiser Fung's *Junk Charts*](http://junkcharts.typepad.com/). Taken together, infosthetics and flowingdata have about ten times the RSS subscribers and 25 times the page views of this humble little blog (based on their sponsorship information [here](http://infosthetics.com/advertise_on_information_aesthetics.html) and [here](http://flowingdata.com/advertise/)).
