...
[Dino Citraro](http://periscopic.com) says…
...
[Stephen North](http://www.research.att.com/vis) says…
...
>
> For academic journals, the main ones in information visualization are the [IEEE Transactions on Visualization and Computer Graphics (TVCG)](http://www.computer.org/portal/web/tvcg), the [Information Visualization Journal](http://ivi.sagepub.com/), and [IEEE Computer Graphics and Applications](http://www.computer.org/portal/web/computingnow/cga). The main conferences are [VisWeek](http://visweek.org/) and [EuroVis](http://eurovis.org/).
...
[Dean Meyers](http://www.deanmeyers.net) says…
...
[jakob](http://blog.jochmann.me) says…
...
[Bill Longabaugh](http://www.BioFabric.org) says…
