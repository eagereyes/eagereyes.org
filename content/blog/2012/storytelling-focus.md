...
Did Minard leave things out? Well, let’s see. Perhaps we can compare his elegant and simple chart to two that [Vladimir ](http://commons.wikimedia.org/wiki/User:Vladlen666)[Volkov](http://commons.wikimedia.org/wiki/User:Vladlen666) created for Wikipedia (click the images for larger versions). [The first one](http://en.wikipedia.org/wiki/File:Patriotic_War_of_1812_ENG_map1.svg) captures the march to Moscow, and roughly the first leg of Minard’s chart.

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2012/09/1000px-Patriotic_War_of_1812_ENG_map1.svg_.png" alt="" width="600" height="403"/></figure>

[The second one](http://en.wikipedia.org/wiki/File:Patriotic_War_of_1812_ENG_map2.svg) describes Napoleon’s retreat, with the time period again mirroring Minard’s chart (the black, second leg this time).

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2012/09/1000px-Patriotic_War_of_1812_ENG_map2.svg_.png" alt="" width="600" height="500"/></figure>

And now compare to Minard:

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2012/08/Minard-Napoleon-Scan.png" alt="" width="668" height="318"/></figure>
