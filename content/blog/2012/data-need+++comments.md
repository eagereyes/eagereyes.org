...
[Anna Powell Smith](http://darkgreener.com) says…
...
[Rick Wicklin](http://blogs.sas.com/content/iml) says…
> The original plot shows the data. The second and third plot display a *model* of the data. The model enables you to tell a nice story, but as others have pointed out, some people might disagree with your model/story and want to propose their own models that tell different stories.
>
...
[david k waltz](http://treasurycafe.blogspot.com) says…
