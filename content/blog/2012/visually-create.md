...
This is where [Visual.ly](http://visual.ly/) comes in. Their idea is not only to connect designers with companies looking for information graphics, but also to provide the tools to make creating them easier and more flexible.
...
<figure><img src="https://media.eagereyes.org/wp-content/uploads/2012/04/visually-templar.png" alt="" width="600" height="600"/></figure>
...
*Visual.ly Create* is a good step in the right direction. It is a bit less ambitious than [what I wrote about last summer](/blog/2011/visually-the-future-of-data-based-infographics), but also much more concrete and usable without requiring both designers and data wranglers to abandon their existing tools. Turning data into understandable, graphical communication is a difficult task, and one that can benefit from better tools than the status quo. Visual.ly is building some of those tools.

---

Disclosure: I am an advisor for Visual.ly. I have brokered a partnership between Visual.ly and Tableau that has led to [some interesting first results](http://blog.visual.ly/visualizing-super-pac-spending/).
