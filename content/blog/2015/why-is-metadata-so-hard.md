...
One huge issue of course is that there are no good standards for metadata. We're still largely at the mercy of PDF files and unformatted spreadsheets. There is [JSON-stat](http://json-stat.org), but it doesn't appear to be widely supported.
