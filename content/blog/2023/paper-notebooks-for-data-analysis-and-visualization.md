...
This is an invited piece for the *Graphically Speaking* column in CG&amp;A, and I'm obviously biased because I work for [Observable](https://observablehq.com/) now. There are a fair number of computational notebook platforms out there though, like [R Markdown in RStudio](https://rmarkdown.rstudio.com/lesson-10.html), [Jupyter for Python](https://jupyter.org), etc.
