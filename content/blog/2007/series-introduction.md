...
This project has two goals: put together a really interesting reading list, and get to know the contributors better. I am in no way interested in the personality cult that exists in some other fields (notably mathematics with the [Erdős number](http://en.wikipedia.org/wiki/Erd%C5%91s_number), or design with its [superstars](http://www.designobserver.com/archives/020303.html)), and the goal of this project is really the opposite of that. All the visualization researchers I know are extremely friendly, interested, and approachable. By learning about what influences them, we get to know them better, and make this field more of a community.

The topic [Lists of Influences](/tag/influences/) shows you the growing list of lists of influential influences.
