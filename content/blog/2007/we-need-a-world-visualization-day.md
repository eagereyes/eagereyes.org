...
There are many *World X Days*, from [World Usability Day](http://www.worldusabilityday.org/) to [International Talk Like A Pirate Day](http://www.talklikeapirate.com/) – we really should be able to match at least the latter. There is no real reason for having a specific day, other than that it's a great way to get attention for a cause. Media are driven by press releases and events, they pick up stories like that. If you listened to the radio on September 19, how many stories about pirates did you hear?

What is a World Visualization Day, anyway?
- Activities on university campuses and in public places (see the world usability day): demos, talks, posters, crowds going wild (think [Hans Rosling](http://video.google.com/videoplay?docid=2670820702819322251))
...
- Organize events
- Collect ideas
If you're attending the [Vis/InfoVis conference](http://vis.computer.org/vis2007/) in Sacramento, come to the BOF on Monday, October 29 at 6pm!
