...
[Stephen Few](http://www.perceptualedge.com) says…
> Robert,
>
...
[Enrico Bertini](http://diuf.unifr.ch/people/bertinie/visuale/) says…
> Hi Robert, just a quick note to let you know I recently replied to this post in [Visuale](http://diuf.unifr.ch/people/bertinie/visuale/), with my personal and somewhat reasoned view on "[Who is the user in InfoVis?](http://diuf.unifr.ch/people/bertinie/visuale/2007/07/whos_the_user_in_infovis.html)". I think you might be interested ;-)
>
> Best,
> Enrico.

aresnick says…
> You say, "The current view of course is that visualization systems should be designed in a way that is useful to domain experts with little to no knowledge of visualization. In reality, of course these are not the actual users of visualizations: rather, the tools are run by their developers, in communication with the domain experts."
>
> I've no real experience with information visualization, and I was wondering how this meshes with [your recent post](../../blog/2009/a-better-vis-web-community.html) about the desire for substance in the infoviz community.  In particular, I didn't realize there already was a community around pairing infoviz experts with domain experts.  Is this within the context of consulting?  I came by these posts while searching for examples of how infoviz experts work _with_ domain experts, thinking that there were few.  I'd be especially interested to hear about examples of domain experts and infoviz experts meeting halfway, where each gets familiar with the others' skillset (maybe by diving into molecular biology/playing with Processing) to mutual benefit.
