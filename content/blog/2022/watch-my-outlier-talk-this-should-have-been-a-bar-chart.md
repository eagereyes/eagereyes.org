...
I use a few quotes from [the paper I published with Matt Brehmer at VIS last year](/blog/2021/paper-from-jam-session-to-recital-synchronous-communication-and-collaboration-around-data-in-organizations), one of which got quite a few reactions right after the talk in February: *to show ordinary data in extraordinary ways*. I should probably have gone with that one as the title (I actually am for [an upcoming talk at the New York Data Vis Meetup](https://www.meetup.com/DataVisualization/events/285428471/)), because it summarizes what I think we should strive for in a really crisp and pithy way.
...
You can watch the talk below or [over on YouTube](https://www.youtube.com/watch?v=GeRgED7LWr8). Like in my other videos, this one also has numbered references throughout, which are collected on this references page.
