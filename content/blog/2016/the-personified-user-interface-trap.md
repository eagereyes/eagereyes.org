...
The teaser image above is the opener of [an article from the November/December 1997 issue of ACM's *interactions* magazine.](http://www.cs.umd.edu/~ben/papers/Shn-Maes-v4n6-1997.pdf) It summarizes the debate between Ben Shneiderman and AI researcher Patti Maes, which they had at two conferences that year. Ben had been going after agents for a while before then it seems, including a 1992 panel he was on with the great title, [*Anthropomorphism: From ELIZA to Terminator 2*](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.80.3719&amp;rep=rep1&amp;type=pdf).
