...
I've recently started doing more of this stuff again, and figured [a new blog](https://shift-register.org/) was a good place to document my projects. These are going to mostly be small things, but hopefully interesting to some people. The first posting talks about [a digital-to-analog converter (DAC) I built using just resistors](https://shift-register.org/2016/discrete-digital-to-analog-converter-using-an-r2r-network) (and, well, a shift register). I'm planning lots of other things like this, some analog, some digital circuits. Many will also include some sort of microcontroller component, mostly Arduinos.
