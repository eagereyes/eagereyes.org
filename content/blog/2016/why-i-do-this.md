...
That is not to say that this website has anything remotely approaching complete coverage, but I try. I write about papers when I go to [conferences](/tag/conference). I sometimes write about individual pieces of research, but not as much as I probably should. And I point to [my own research](/tag/paper), of course.
...
Two projects I followed closely from their beginning to their eventual demise were [Many Eyes and Swivel](/criticism/swivel-vs-many-eyes). I [wrote about Many Eyes on Tuesday](/blog/2016/the-controversies), but I actually put an equal amount of work into Swivel. In case you don't remember: Swivel was a data visualization website that was much simpler and academically less ambitious than Many Eyes, but seemed much more driven by a clear strategy. When it started to decline, [I interviewed its founders](/criticism/the-rise-and-fall-of-swivel) and they spoke very frankly about their failures. I then also [got ahold of the venture capitalist who had bankrolled the project](/criticism/swivel-part-2-solving-a-single-problem) to get his take.

Other things are smaller, but I think they're important to know and point people to. When I realized that [TVCG had switched the way it published VIS papers](/blog/2015/vis-proceedings-now-in-the-january-issue-of-tvcg), I wrote about that. When I learned that [MTurk worker IDs were easily connected to real people](/blog/2016/mturk-ids-are-not-anonymous), I did the same.

And some things are arguably tenuous connections, but worth considering. I've argued that the Nobel Prize Al Gore and the UN Intergovernmental Panel on Climate Change were awarded in 2007 was[ a Nobel Prize for data visualization](/blog/2007/nobel-prize-for-charts). And I keep writing about information graphics, journalism, and other topics.

## To Read the Tea Leaves

In early 2010, I wrote a posting titled [*The State of Information Visualization*](/blog/2010/state-of-infovis-2010) on a whim. The title was meant to be preposterous, but the idea was serious: capture what's happening in the field and figure out where things are going from here. I have now written seven of those postings.

Who else takes stock of what's going on in the field? I think this is important. And it's not exactly done much. The only ones other than me are Moritz and Enrico with the [year-end episodes of their podcast](http://datastori.es) and [Andy Kirk's monthly and six-monthly roundups](http://visualisingdata.com).
...
This has also made me appreciate good writing and good communication. There's a lot to be learned from the people [who know how to write and explain things](/blog/2015/review-munroes-thing-explainer-and-pinkers-sense-of-style). For all the writing academics do, that is oddly something that they don't pay nearly as much attention to as they should.
...
The teaser image is a painting by [Mike Monteiro](https://twitter.com/monteiro). You'll never guess [where that quote is from](http://www.grammarphobia.com/blog/2011/10/bridges.html).
