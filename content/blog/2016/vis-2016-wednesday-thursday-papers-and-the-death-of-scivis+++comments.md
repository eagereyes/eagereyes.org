...
> Yes, in the data journalism and infographics worlds, this is a very common workflow. There's *a lot* you can do much faster and more easily in Illustrator than in code. In principle most or all of that can be done in D3 directly, but it's way more effort and takes much longer.
