...
<figure><img src="https://media.eagereyes.org/wp-content/uploads/2016/04/image.jpeg" alt="Spreadsheet" width="655" height="230"/></figure>
...
<figure><img src="https://media.eagereyes.org/wp-content/uploads/2016/04/image-1.jpeg" alt="Database" width="169" height="215"/></figure>
...
The other operation, the *unpivot,* is much more difficult and error-prone. When the data is already in proper table format (with all the stuff around the pure data removed), it works well though. Tools like [Trifacta Wrangler](/blog/2015/trifacta-wrangler-for-cleaning-and-reshaping-data) and Tableau can perform unpivots (though Tableau calls it pivot, just to be different).
