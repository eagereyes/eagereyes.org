...
If you want to see who spoke at the last few conferences, check out [the YouTube channel and watch the videos](https://www.youtube.com/user/TapestryConference)! We've had people like Alberto Cairo, Hannah Fairfield, Kim Rees, Nick Sousanis, Martin Wattenberg and Fernanda Viégas (aka *Marnanda*), Giorgia Lupi, and many other amazing speakers in the past. I also wrote a little article about the conference last year.

## Keynotes

For next year, we have these three amazing people to give the keynotes:

- [Lena Groeger](http://lenagroeger.com) works for ProPublica where she has created some amazing interactive news pieces. She also writes [interesting and fun pieces for the ProPublica blog](https://www.propublica.org/site/author/lena_groeger).
- [Neil Halloran](http://www.neilhalloran.com) is the guy behind such *cinematic data visualization* pieces as [fallen.io](http://fallen.io/) (which, if you haven't seen it, you really need to watch).
- [Michelle Borkin](http://people.seas.harvard.edu/~borkin/) is a professor at Northeastern University who has done some [very exciting research on memorability in visualization](http://massvis.mit.edu) (and lots of other interesting work).
...
We'll also have six short stories, as well as posters and demos. And that's where you come in: we want your proposals! Go to [the website](http://www.tapestryconference.com) and send us your talk proposals! The deadline for that is December 1, but there's no penalty for submitting them early. In fact, that might actually help get yours accepted.
...
We picked a beautiful little hotel in St. Augustine for the conference this time. St. Augustine is a beautiful town with a lot of history. [Wikipedia boasts](https://en.wikipedia.org/wiki/St._Augustine,_Florida) that it's *the oldest continuously occupied European-established settlement within the borders of the contiguous United States*. And it's just a cute town with lots going on.

There's more information on the [Tapestry website](http://www.tapestryconference.com) and you should also follow the [Tapestry Twitter account](https://twitter.com/tapestryconf) for more information.

---

[Teaser image by Steven Martin](https://www.flickr.com/photos/stevenm_61/14061151590/)
