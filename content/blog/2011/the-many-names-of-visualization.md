...
It's the generic term for all of visualization, though historically it has denoted scientific visualization. Traces of that are still there, like the *Vis* track at [VisWeek](http://visweek.org/), that would be much better served by the term *SciVis* (as the counterpart to *InfoVis*). That would also eventually make it possible to use "Vis" again as a shortcut for the entire conference, not just one track.
...
[Teaser image via Flickr](http://www.flickr.com/photos/oxygeon/238163317/in/photostream/)Ó
