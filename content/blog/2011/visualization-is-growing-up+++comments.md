...
> Hey Robert, just to clarify a point about the V&V panel: VTK's implementation of MC was fine! It was Macet (a MC variant in a recent TVCG paper of our own) that had a nasty bug. More details in our paper, [here](http://cscheid.net/papers/verifiable_visualization_for_isosurface_extraction).

Robert Kosara says…
> I thought it was vtk, because Claudio(?) said that almost everybody who's using Marching Cubes has that issue.

[Thorri](http://www.datamarket.com) says…
