...
I called 2010 [the year of InfoVis theory](/blog/2010/the-year-of-infovis-theory), and I wasn't too far off. There were papers on theory at the Vis and InfoVis conferences, and a workshop on theory in visualization. Of course, I was involved in some of those things myself, but I was hardly the only one there.

Another big theme at VisWeek 2010 was storytelling in visualization. The [day-long workshop on the topic](http://thevcl.com/storytelling/) was interesting, and there was a good paper on storytelling formats, but I still feel we're missing something. There must be more to storytelling in visualization than trying to emulate movies or newspaper articles.

Last year also saw the [disappearance of Swivel](/criticism/the-rise-and-fall-of-swivel), its [brief reappearance](/criticism/swivel-part-2-solving-a-single-problem), and finally(?) it's descent into some kind of limbo (you currently end up on some DNS service's landing page). Verifiable.com [also shut down last year](/blog/2010/end-of-verifiable-com), calling into question the viability of visualization-as-a-service websites.
...
The hope is that IE 9 will be adopted quickly, finally removing the last excuses not to unleash [the power of HTML5](/blog/2010/html5-and-visualization-on-the-web) on the web. With a large majority of users finally having capable browsers, it will be possible to build native visualization widgets that seamlessly fit into webpages, just like images.
...
Meaningful visualizations will also help on another front that I see becoming a real problem: the dumbing-down and trivialization of visual data representation. Infographics of all kinds are floating around the Internet, and people are slowly but surely [getting sick of them](http://www.noahbrier.com/archives/2011/01/on_infographics.php). What is more, a lot of people do not realize the [difference between infographics and visualizations](/blog/2010/the-difference-between-infographics-and-visualization), and instead just consider them all just useless eye candy.
