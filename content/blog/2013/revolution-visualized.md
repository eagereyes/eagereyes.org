...
Pitch Interactive’s [*Out of Sight, Out of Mind*](http://drones.pitchinteractive.com/) shows U.S. drone strikes in Pakistan. It breaks down the victims into high-profile targets, alleged combatants, civilians, and children. It’s essentially a stacked bar chart.
...
*The Huffington Post*’s [*Mapping the Dead: Gun Deaths Since Sandy Hook*](http://data.huffingtonpost.com/2013/03/gun-deaths) shows gun deaths since the elementary school shooting that got so much attention last December. It's a simple map, but with a twist: it zooms out from Newtown, CT, to reveal the entire U.S. and all the gun deaths over the last few months. It's breathtaking.
