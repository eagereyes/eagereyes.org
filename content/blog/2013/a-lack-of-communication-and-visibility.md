...
- You can read blogs. I’ve written [summaries of conferences](/tag/conference) and the [odd posting about particular papers](/tag/paper) (though mostly my own). But the conference summaries tend to only flag papers and give very little context. In addition, you can wait for [Stephen Few](http://www.perceptualedge.com/blog/) to rip a paper apart, but he also only does that once or twice a year, thankfully.
