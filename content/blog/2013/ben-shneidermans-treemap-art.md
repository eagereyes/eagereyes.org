...
The pieces are [available as PDFs](http://treemapart.wordpress.com/full-views/) for printing at any size. It pays to zoom into the gray ribbon at the bottom or on the side to read the short explanation of the data and the artistic influence. There is also a [blog of draft designs](http://treemapart.wordpress.com/category/draft-designs/), which provides a window into some of the process. This is fairly rare in research, much more common in art and design, and quite interesting.
