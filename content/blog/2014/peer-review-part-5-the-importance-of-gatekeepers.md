...
That is not to say that there isn’t great work out there that isn’t going through peer review. [Bret Victor](http://worrydream.com) has never published an academic paper, and his work is amazing. But he is an exception. Work does not have to be vetted to be good. But if you're looking for good work, you end up going to the places that rigorously select and filter.

The science world is looking for some sort of middle ground, too. There are places like [arXiv.org](http://arxiv.org), which provides a reasonably structured (though entirely non-reviewed) place to make papers available and discuss them. [PLOS ONE](http://www.plosone.org), which the Quilt Plots paper was published in, has less stringent reviewing criteria and tends to err on the side of accepting more, rather than less. And there are certainly more.
...
What I hope this little series has shown is that peer review is a complex process that has many things going for it. While [the paper that got me to write over 4,000 words on the topic](/blog/2014/1-quilt-plots) was clearly not one of the brighter spots in the history or peer review, it’s a good system overall. There are [many ways a paper can be bad](/blog/2014/3-a-taxonomy-of-bad-papers), but there are also [good reasons why those get submitted](/blog/2014/4-good-reasons-for-bad-papers). I’ve glanced over many issues and details in [describing the process](/blog/2014/2-how-it-works), and there are easily ten times as many words to be written about all the issues in academic publishing, especially outside of the mostly well-functioning technical sciences.
...
This is the last part of [a five-part series on peer review in visualization](/tag/peer-review). One posting a day was posted throughout this week. One or two further parts may follow in the coming weeks.

[Teaser image by Paolo Del Signore](http://www.flickr.com/photos/padesig/193865429/), used under Creative Commons.
