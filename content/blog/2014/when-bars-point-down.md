...
<figure><img src="https://media.eagereyes.org/wp-content/uploads/2014/06/scarr-iraqs-bloody-toll.jpg" alt="Simon Scarr, Iraq" width="730" height="1083"/></figure>

The first time I saw this effect was at [Malofiej 2012](/blog/2012/malofiej-20), where one of the entries was [Simon Scarr's *Iraq's Bloody Toll*](http://www.scmp.com/infographics/article/1284683/iraqs-bloody-toll), which he had created for the *South China Morning Post*. I was shocked. It was such a simple effect, and incredibly striking. Seeing it in print, on a full newspaper page, made it even stronger. The graphic ended up winning a silver medal, and I'm really sorry that it didn't make gold (I was on the jury and argued for gold, but didn't fight hard enough for it).
...
<figure><img src="https://media.eagereyes.org/wp-content/uploads/2014/06/obama-job-loss-chart.png" alt="Obama Job Loss Chart" width="730" height="407"/></figure>

An older example uses the same idea to great effect: [The Obama Administration Job Loss chart, also known as *The Bikini Chart*](/blog/2012/bikini-chart). It's not quite so striking, but I like how it implicitly tells you how to read it.
...
The Economist has created a number of charts with downward-pointing bars. Some of them are more obvious, like [this one on the severity of financial crises](http://www.economist.com/blogs/graphicdetail/2014/04/daily-chart-7).

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2014/06/economist-hard-times.png" alt="The Economist, Stock Market Losses During Selected Financial Crises" width="730" height="463"/></figure>

But with others, the choice is much more deliberate and unusual. [This stark depiction of the number of executions](http://www.economist.com/blogs/graphicdetail/2014/03/daily-chart-19) uses the same metaphor of bars pointing down for positive numbers (of deaths), and was undoubtedly inspired by Scarr. In addition to the direction, the vertical scale was also clearly chosen to make a point.

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2014/06/economist-executions.png" alt="The Economist, Executions" width="730" height="2351"/></figure>

## Florida Gun Deaths

When looking at such a chart idea, it is not only instructive to look at examples that do it well, but also at ones where it fails. A chart made the rounds in early April that used the same idea for [gun deaths in Florida](http://www.businessinsider.com/gun-deaths-in-florida-increased-with-stand-your-ground-2014-2). It was widely derided as bad, misleading, and politically motivated (see the great summaries of the controversy by [Andy Kirk](http://www.visualisingdata.com/index.php/2014/04/the-fine-line-between-confusion-and-deception/) and [Alberto Cairo](http://www.thefunctionalart.com/2014/04/in-visualization-baselines-and-negative.html)). While I agree that it didn't succeed, the amount of hate poured on it (and poor [Christine Chan](https://twitter.com/ChristineHHChan)) was unwarranted.

<figure><img src="https://media.eagereyes.org/wp-content/uploads/2014/06/chen-florida-gun-deaths.jpg" alt="Christine Chan, Florida Gun Deaths" width="604" height="756"/></figure>
