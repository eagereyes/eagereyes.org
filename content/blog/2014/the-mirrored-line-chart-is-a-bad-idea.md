...
When the data is coming from polling results, at least there are undecided voters who add a bit of interest. Though even that is often [misrepresented or downright hidden](/blog/2012/embracing-uncertainty-two-line-charts). But here, there isn't even uncertainty. It's a simple sum of two numbers. It's redundant information.
