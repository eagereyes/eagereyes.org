...
I understood what had bothered me beyond the aesthetics when Elijah Meeks made an interesting point: the core issue here was that [the average was treated as part of the data, rather than as metadata ](https://twitter.com/Elijah_Meeks/status/854429661979332608). The average is not a special value, it's not a data value at all! It's not part of the data.
...
But what's more, data tables aren't like printed ones. They are the raw material for further processing, not the end result. [They need to be readable by machines, not humans](/data/dish-best-served-raw). Including averages and other derived values shows a fundamental misunderstanding of this basic fact.
