...
[Andrew Begin](http://www.zingchart.com) says…
...
>
> One top of mind example where chart junk is not combined with – nor supportive of – the data is located in this [retrevo article](http://www.retrevo.com/content/blog/2010/03/social-media-new-addiction%3F) about social media. The stock photos/graphics are loosely connected at best, and make it hard to focus on the data. This would be an interesting set of charts study.
>
...
[Aneesh Karve](http://arcball.com) says…
> This is reminiscent of the Japanese ATM study mentioned in *Emotional Design*. The conclusion? Users perform better with prettier ATMs.
>
...
>
> The lesson for designers, in any case, is to *address both the emotional and behavioral dimensions of cognition*.
> - Chartjunk is excessive to the extent that it impedes quantitative judgements
> - Chartjunk is useful to the extent that it is esthetically pleasing, fun, and memorable
>
> Perhaps [Kahneman's concepts of the remembering (embellishing?) versus experiential (objective?) selves](http://www.ted.com/talks/daniel_kahneman_the_riddle_of_experience_vs_memory.html) can provide insight into the balance.
>
...
[Ryan Flynn](http://parseerror.com/vis/) says…
...
[Matt](http://technicalproblemsolving.blogspot.com) says…
...
[Paolo Ciuccarelli](http://www.densitydesign.org) says…
