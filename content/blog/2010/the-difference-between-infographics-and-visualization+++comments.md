[Jacqui Taylor](http://www.flyingbinary.com) says…
> Robert
>
...
[Alark Joshi](http://visualizeit.wordpress.com) says…
> Great post, Robert!
>
...
[Tim Vision](http://www.optegra.com) says…
...
>
> So, infographics are * usually * bespoke, because at the point they are made the nuances of the data are known, so complete customisation is possible. Visualisations are * usually * general purpose, because they are made before and while the nuances that would guide customisation are being discovered.
>
> But there are exceptions: for example, genetic and hospital  incidence data sets are analysed and visualised using custom tools that are quite heavily adapted to the nuances that it is known these types of data set * usually * have. There's a grey area between the two.
>
> Many of the most popular online public-facing visualisations (e.g. ITOworld's traffic accident visualisations) are what you could call par-baked - they have been analysed up to the point of understanding the basic nuances and understanding how to get the most out of the visualisation by customising it. They are part customised, data-set * series * specific (you can whack next year's traffic accident data in and use it, but you can't stick, say, malaria stats in and get something useful), and about * guided exploration * rather than pure exploration (e.g. like Tableau), or communicating one set interpreted message which might not be true in next year's data, which is what infographics do.
>
...
>
> Keep an eye out for the English translation of Alberto Cairo's [El Arte Funcional](http://www.amazon.es/Arte-funcional-infografia-visualizacion-informacion/dp/8498890675/ref=sr_1_1?ie=UTF8&amp;qid=1320254073&amp;sr=8-1) which I hear is [coming out this summer](http://infographicsnews.blogspot.com/2011/12/functional-art-all-you-need-to-know.html) - it does a better job than me looking into the different requirements of exploration and communication data graphics.

[Chris](http://storiesthroughdata.blogs.lincoln.ac.uk) says…
> Hi Robert,
>
...
[Patrick](http://graphoftheweek.org/) says…
