...
You can watch the video [over on YouTube](https://youtu.be/hlb1uM_SOcE) or right here.
...
I've written about [the need to reduce the amount of data shown to tell a story](/journalism/storytelling-minard-vs-nightingale) before (using Minard's chart even). An important source has also been [Menno-Jan Kraak's book, *Mapping Time*](/blog/2014/review-kraak-mapping-time), as well as [Sandra Rendgen's *The Minard System*](https://sandrarendgen.wordpress.com/2018/06/20/new-book-the-minard-system-fall-2018/) (which makes an appearance in the video).
