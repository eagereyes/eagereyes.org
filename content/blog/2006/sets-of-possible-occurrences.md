...
<figure><img src="https://media.eagereyes.org/media/attachments/SOPOSameLength.png" alt="SOPO showing intervals of equal length" width="200" height="190"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/attachments/SOPORectangle.png" alt="Rectangular SOPO" width="200" height="191"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/attachments/SOPOFull.png" alt="Fully constrained SOPO" width="200" height="191"/></figure>
...
<figure><img src="https://media.eagereyes.org/media/attachments/SOPOViewShot2.png" alt="SOPOView" width="555" height="341"/></figure>
...
Why bother talking about SOPOs, when they are so unintuitive? While they will not replace the [Gantt chart](http://en.wikipedia.org/wiki/Gantt_chart) anytime soon, they have some interesting properties.
...
Unintuitive as they are, SOPOs help us break out of the usual way we look at time, and make us aware of the many assumptions we make about visual representations of the fourth dimension. That alone makes studying them worthwile, even if their role is that of the ladder in [Wittgenstein's metaphor](http://en.wikipedia.org/wiki/Tractatus_Logico-Philosophicus): after we have reached a higher point with their help, we can leave them behind.
